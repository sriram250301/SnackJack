package com.snackjack.androidapp.ui.addtocart;
...
import com.snackjack.androidapp.firebase.FirebaseInit;
...
public class AddToCart extends AppCompatActivity {
    ...
    private void setViews() {
        ...
        Glide.with(getApplicationContext()).load(imageLink).placeholder(R.mipmap.ic_launcher).into(productimage);
